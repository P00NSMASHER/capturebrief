...
from .deviation_applicability import deviation_applicability_work_items
...
def build_work_queue(
    ...
    *,
    ...
    for deviation_applicability_task in deviation_applicability_work_items(case):
        add(deviation_applicability_task)
